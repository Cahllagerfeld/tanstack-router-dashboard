			...
			<Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
				...
				>
					<SheetHeader className="sr-only">
						<SheetTitle>{m.common_navigation_sidebar_title()}</SheetTitle>
						<SheetDescription>
							{m.common_navigation_sidebar_description()}
						</SheetDescription>
					</SheetHeader>
...
function SidebarTrigger({
	...
	return (
		...
		>
			<PanelLeftIcon />
			<span className="sr-only">{m.common_navigation_toggle_sidebar()}</span>
		</Button>
	);
}
...
function SidebarRail({ className, ...props }: React.ComponentProps<"button">) {
	...
	return (
		<button
			...
			aria-label={m.common_navigation_toggle_sidebar()}
			tabIndex={-1}
			onClick={toggleSidebar}
			title={m.common_navigation_toggle_sidebar()}
			className={cn(
