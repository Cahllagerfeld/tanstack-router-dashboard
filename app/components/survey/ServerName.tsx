...
import { ServerNameFormSchema, ServerNameFormType } from "./schemas";
		...
		<div className="max-w-[570px] space-y-5">
			<div>
				<h1 className="text-display-xs font-semibold">
					Almost there! Select a server name
				</h1>
				<p className="text-theme-text-secondary">
					This will identify your ZenML server. You can use the generated name
					or create your own.
				</p>
			</div>
